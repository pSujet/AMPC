...
ctrl = RMPC(sys, params.ctrl, 0.7, 'mosek');
...
rho = 0.9; % TODO: Try different values for rho and fix it for the remainder of the exercise
...
% computation times.
ctrl = RMPC(sys, params.ctrl, rho ,'mosek');
