...
classdef KF < Parameter_Estimator
    ...
    methods
        ...
        function [theta, Sigma] = prediction_update(obj)
            ...
            theta = obj.theta; % Compute the prediction update \theta_{p,k} as a function of the previous estimate \hat{\theta}_{k-1}=obj.theta
            Sigma = obj.Sigma + Sigma_w_theta; % Compute the prediction update \Sigma^\theta_{p,k} as a function of the previous estimate \Sigma^\theta_{k-1}=obj.Sigma
